export const COACHING_TIPS = {
  ...
  close_ratio: {
    why: "Close ratio measures how much of what you present actually gets approved and sold — a shop finding 5–7 hours per car but only selling 1.5 is hemorrhaging revenue on work already identified. Target close ratio is 50% when presenting everything found.",
    causes: [
      "Service advisors are pre-qualifying what to present before the customer ever hears it",
      "DVIs are being completed but not shared with the customer — many shops send fewer than 70% of inspections to customers",
      "Presentation is verbal-only — customers who can see the inspection approve at higher rates",
      "Declined repairs aren't being tracked or followed up — 52% of customers will authorize declined work if contacted before they leave",
    ],
    tips: [
      "Require your service advisor to estimate 100% of what the technician flags, no exceptions — the tech's job is to find it, the advisor's job is to present it, the customer's job is to decide.",
      "Track your DVI share rate in your software and set a minimum of 70% — if the customer isn't seeing it, the inspection dollars are wasted.",
      "When reviewing declined repairs at vehicle pickup, ask the customer to schedule the next visit before they walk out — closing rate on pre-scheduled return visits is 52%.",
      "Frame every DVI presentation around outcomes, not parts: you're not selling struts, you're selling 'your car starts reliably tomorrow morning.'",
    ],
    quickWin: "Pull this week's repair orders and count how many DVIs were completed vs. how many were actually sent to the customer. That gap is your fastest close ratio lever.",
  },
